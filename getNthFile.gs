...
//Gets num file and returns is fileId, name, and size.
function doGet(e) {

  var params = e.parameters.num;
  var num = params[0]
  ...
  size = lastFile.getSize()
  return ContentService.createTextOutput(id + ' ' + name + ' ' + size);
}
